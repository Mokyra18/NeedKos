                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                                        alt="icon">
                                    <p class="text-sm text-ngekos-grey">{{ optional($boardingHouse->rooms->first())->capacity }} people
                                    </p>
                                </div>
                                <hr class="border-[#F1F2F6]">
            ...
            <a href="cities.html" class="card">
                <div
                    ...
                    <div class="flex flex-col gap-[2px]">
                        ...
                        <p class="text-sm text-ngekos-grecy">1,304 Kos</p>
                    </div>
                </div>
            </a>
                ...
                <div class="flex flex-col gap-3 w-full">
                    <h3 class="font-semibold text-lg leading-[27px] line-clamp-2 min-h-[54px]">{{  $boardingHouse->name }}</h3>
                        ...
                        <div class="flex items-center gap-[6px]">
                            <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                            alt="icon">
                            <p class="text-sm text-ngekos-grey">{{ optional($boardingHouse->rooms->first())->capacity }} people</p>
                        </div>
                        <hr class="border-[#F1F2F6]">
                        <p class="font-semibold text-lg text-ngekos-orange">Rp {{  $boardingHouse->price  }}<span
                            class="text-sm text-ngekos-grey font-normal">/bulan</span></p>
